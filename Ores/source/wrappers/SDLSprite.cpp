...
SDLSprite::SDLSprite(std::string& spritePath)
	:m_texture(TextureManager::GetSpriteFromSpriteFilePath(spritePath), SDL_DestroyTexture)
{
}
...
{
	printf("set sprite\n");
	m_texture.reset(TextureManager::GetSpriteFromSpriteFilePath(spritePath));
}
